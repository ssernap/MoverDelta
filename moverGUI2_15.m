function varargout = moverGUI2_15(varargin)
% MOVERGUI2_15 MATLAB code for moverGUI2_15.fig
%      MOVERGUI2_15, by itself, creates a new MOVERGUI2_15 or raises the existing
%      singleton*.
%
%      H = MOVERGUI2_15 returns the handle to a new MOVERGUI2_15 or the handle to
%      the existing singleton*.
%
%      MOVERGUI2_15('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MOVERGUI2_15.M with the given input arguments.
%
%      MOVERGUI2_15('Property','Value',...) creates a new MOVERGUI2_15 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before moverGUI2_15_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to moverGUI2_15_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help moverGUI2_15

% Last Modified by GUIDE v2.5 16-Oct-2016 20:12:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @moverGUI2_15_OpeningFcn, ...
                   'gui_OutputFcn',  @moverGUI2_15_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function moverGUI2_15_OpeningFcn(hObject, eventdata, handles, varargin)
global coordenadas ingresadas HomeTH1 HomeTH2 HomeTH3
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to moverGUI2_15 (see VARARGIN)

% Choose default command line output for moverGUI2_15
...
function varargout = moverGUI2_15_OutputFcn(hObject, eventdata, handles) 
...
A3=CalculoPolinomios(Th3,Tiempo);
 ...
 TiempoAcu=[0,cumsum(Tiempo)]
    ...
    %Calcular Funciones intermedias de los puntos Optimo
